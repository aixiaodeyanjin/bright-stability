...
const hideCredit = (viewer) => (viewer._cesiumWidget._creditContainer.style.display = 'none');
/**
 * Cesium.Viewer 默认配置
 */
const OPTIONS = {
...
class CesiumViewerBuilder {
   ...
   */
  getOptions() {
    let opts = Object.assign({}, CesiumViewerBuilder.defaultOptions, this.userOptions);
