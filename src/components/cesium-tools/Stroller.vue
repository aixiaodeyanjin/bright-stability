    ...
    <div class="path-plan">
        <div class="path-coord-info" v-show="isDoPlanRoute">
            ...
            <div class="input-wrapper">
                <span>经度:</span><input v-model="planRouteData.currCoord.longitude" type="number" step=".00001" autocomplete="off" v-on:input="currCoordChange">
            </div>
            <div class="input-wrapper">
                <span>纬度:</span><input v-model="planRouteData.currCoord.latitude" type="number" step=".00001" autocomplete="off" v-on:input="currCoordChange">
            </div>
            <div class="input-wrapper">
                <span>高度:</span><input v-model="planRouteData.currCoord.height" type="number" step=".5" autocomplete="off" v-on:input="currCoordChange">
            </div>
        </div>
  ...
  methods: {
    ...
    planRoute () {
      ...
      this.planRouteTool.addRouteChangeHandler((cartesian) => {
        ...
        this.planRouteData.currCoord = {longitude: CesiumMath.toDegrees(longitude), latitude: CesiumMath.toDegrees(latitude), height}
     ...
     */
    currCoordChange () {
      let {planRouteData: { currIndex, currCoord: {longitude, latitude, height}, coords }} = this
      if (currIndex >= 0) {
